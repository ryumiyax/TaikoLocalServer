...
public partial class TaikoDbContext
{
    ...
    public virtual DbSet<ChallengeCompeteArchievement> ChallengeCompeteArchievementData { get; set; } = null!;
    ...
    partial void OnModelCreatingChallengeCompete(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.CompId, e.SongIndex });
        ...
        modelBuilder.Entity<ChallengeCompeteBestDatum>(entity =>
        {
            ...
            entity.HasOne(e => e.ChallengeCompeteSongData)
                ...
                .HasPrincipalKey(p => new { p.CompId, p.SongIndex })
                .HasForeignKey(d => new { d.CompId, d.SongIndex })
                .OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<ChallengeCompeteArchievement>(entity =>
        {
            entity.HasKey(e => new { e.Baid });
        });
    }
}
